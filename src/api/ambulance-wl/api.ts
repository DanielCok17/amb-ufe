...
/**
 * Describes disease, symptoms, or other reasons for patient visit
 * @export
 * @interface Condition
 */
export interface Condition {
    ...
    'code'?: string;
    /**
     * Link to an encyclopedic explanation of the patient\'s condition
     * @type {string}
     * @memberof Condition
     */
    'reference'?: string;
...
export const AmbulanceWaitingListApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        /**
         * By using ambulanceId you get a list of entries in the ambulance waiting list
        ...
        /**
         * By using ambulanceId and entryId you get details of a particular entry in the ambulance.
